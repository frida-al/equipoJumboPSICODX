...
CREATE TABLE `aspirantes` (
  ...
  `archivoPDF` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish2_ci 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE `psicologas` (
  `idPsicologa` varchar(36) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
  `idUsuario` varchar(36) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
...
CREATE TABLE `respuestasPreguntasFormatos` (
  `idFormato` varchar(36) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
