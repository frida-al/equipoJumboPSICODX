// Modelos
const terman = require('../../models/pruebas/terman/terman.model');
const modeloTerman = new terman();
const calificacionesTerman = require('../../models/pruebas/terman/calificacionesTerman.model');
const resultadosSeriesTerman = require('../../models/pruebas/terman/resultadosSeriesTerman.model');
