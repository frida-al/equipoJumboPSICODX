...
insert into opciones16PF (idOpcion16PF, opcion16PF, descripcionOpcion16PF, idPregunta16PF, valor16PF) values
(UUID(), 'A', 'Las máquinas o llevar registros', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 1), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 1), 1),
(UUID(), 'C', 'Entrevistar y hablar con personas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 1), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 2), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 2), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 2), 0),
(UUID(), 'A', 'Se lo señalo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 3), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 3), 1),
(UUID(), 'C', 'Lo paso por alto', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 3), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 4), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 4), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 4), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 5), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 5), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 5), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 6), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 6), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 6), 2),
(UUID(), 'A', 'Una persona con capacidad de tipo medio, pero con una moral estricta', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 7), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 7), 1),
(UUID(), 'C', 'Una persona con talento, aunque a veces no sea responsable', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 7), 0),
(UUID(), 'A', 'Ingeniero de la construcción', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 8), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 8), 1),
(UUID(), 'C', 'Escritor de teatro', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 8), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 9), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 9), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 9), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 10), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 10), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 10), 2),
(UUID(), 'A', 'Sí', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 11), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 11), 1),
(UUID(), 'C', 'No', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 11), 0),
(UUID(), 'A','Verdadero',(SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 12), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 12), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 12), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 13), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 13), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 13), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 14), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 14), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 14), 2),
(UUID(), 'A', 'Con facilidad cuando las personas parecen estar interesadas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 15), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 15), 1),
(UUID(), 'C', 'Solo si no tengo más remedio', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 15), 2),
(UUID(), 'A', 'Algunas veces.', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 16), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 16), 1),
(UUID(), 'C', 'Nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 16), 0),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 17), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 17), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 17), 2),
(UUID(), 'A', 'Comentar mis problemas con los amigos', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 18), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 18), 1),
(UUID(), 'C', 'Guardarlos para mis adentros', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 18), 0),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 19), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 19), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 19), 0),
(UUID(), 'A', 'Sí', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 20), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 20), 1),
(UUID(), 'C', 'No', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 20), 0),
(UUID(), 'A', 'No me perturba', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 21), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 21), 1),
(UUID(), 'C', 'Normalmente me hace daño', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 21), 0),
(UUID(), 'A', 'Discutir el significado de nuestras diferencias básicas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 22), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 22), 1),
(UUID(), 'C', 'Cambiar el tema', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 22), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 23), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 23), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 23), 2),
(UUID(), 'A', 'Verdadero, para evitar problemas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 24), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 24), 1),
(UUID(), 'C', 'Falso, porque podría hacer algo más interesante', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 24), 2),
(UUID(), 'A', 'Con otros', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 25), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 25), 1),
(UUID(), 'C', 'Yo solo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 25), 0),
(UUID(), 'A', 'Raras veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 26), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 26), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 26), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 27), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 27), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 27), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 28), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 28), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 28), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 29), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 29), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 29), 0),
(UUID(), 'A', 'Eso me molestaría e irritaría', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 30), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 30), 1),
(UUID(), 'C', 'Me parecería bien y estaría contento de cambiarlos', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 30), 0),
(UUID(), 'A', 'Estar en una oficina, organizado y atendiendo a personas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 31), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 31), 1),
(UUID(), 'C', 'Ser arquitecto dibujar planos en un despacho tranquilo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 31), 0),
(UUID(), 'A', 'Me siento como si no pudiera dormir', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 32), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 32), 1),
(UUID(), 'C', 'Continúo de un modo normal', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 32), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 33), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 33), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 33), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 34), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 34), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 34), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 35), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 35), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 35), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 36), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 36), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 36), 2),
(UUID(), 'A', 'Haciendo con tranquilidad y sosiego algo por lo que tenga afición', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 37), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 37), 1),
(UUID(), 'C', 'En una fiesta animada', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 37), 2),
(UUID(), 'A', 'Sí', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 38), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 38), 1),
(UUID(), 'C', 'No', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 38), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 39), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 39), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 39), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 40), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 40), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 40), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 41), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 41), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 41), 0),
(UUID(), 'A', 'La esgrima o la danza', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 42), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 42), 1),
(UUID(), 'C', 'El tenis o la lucha libre', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 42), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 43), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 43), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 43), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 44), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 44), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 44), 0),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 45), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 45), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 45), 2),
(UUID(), 'A', 'Siempre están haciendo cosas prácticas que necesitan ser hechas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 46), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 46), 1),
(UUID(), 'C', 'Imaginan o piensan acerca de cosas sobre sí mismas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 46), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 47), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 47), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 47), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 48), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 48), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 48), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 49), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 49), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 49), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 50), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 50), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 50), 2),
(UUID(), 'A', 'Normalmente verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 51), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 51), 1),
...
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 54), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 54), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 54), 2),
(UUID(), 'A', 'Más ciudadanos íntegros y constantes', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 55), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 55), 1),
(UUID(), 'C', 'Más reformadores con opiniones sobre cómo mejorar el mundo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 55), 0),
(UUID(), 'A', 'Se forman equipos o se tiene un compañero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 56), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 56), 1),
(UUID(), 'C', 'Cada uno hace su partida', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 56), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 57), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 57), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 57), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 58), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 58), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 58), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 59), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 59), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 59), 0),
(UUID(), 'A', 'Verdadero, no me siento mal', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 60), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 60), 1),
(UUID(), 'C', 'Falso, me molesta', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 60), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 61), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 61), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 61), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 62), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 62), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 62), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 63), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 63), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 63), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 64), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 64), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 64), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 65), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 65), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 65), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 66), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 66), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 66), 2),
(UUID(), 'A', 'No están demasiado satisfechas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 67), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 67), 1),
(UUID(), 'C', 'Están bien satisfechas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 67), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 68), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 68), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 68), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 69), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 69), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 69), 0),
(UUID(), 'A', 'De modo aseado y sencillo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 70), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 70), 1),
(UUID(), 'C', 'A la moda y original', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 70), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 71), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 71), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 71), 2),
(UUID(), 'A', 'Verdadero, porque no siempre son necesarias', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 72), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 72), 1),
(UUID(), 'C', 'Falso, por que es importante hacer las cosas correctamente', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 72), 0),
(UUID(), 'A', 'Nunca me ha dado problemas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 73), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 73), 1),
(UUID(), 'C', 'Me cuesta bastante', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 73), 0),
(UUID(), 'A', 'Literatura o cine', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 74), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 74), 1),
(UUID(), 'C', 'Deportes o política', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 74), 0),
(UUID(), 'A', 'A veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 75), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 75), 1),
(UUID(), 'C', 'Raras veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 75), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 76), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 76), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 76), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 77), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 77), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 77), 2),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 78), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 78), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 78), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 79), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 79), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 79), 2),
(UUID(), 'A', 'Normalmente verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 80), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 80), 1),
(UUID(), 'C', 'Normalmente falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 80), 0),
(UUID(), 'A', 'Las cosas prácticas que me rodean', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 81), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 81), 1),
(UUID(), 'C', 'Los pensamientos y la imaginación', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 81), 2),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 82), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 82), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 82), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 83), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 83), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 83), 0),
(UUID(), 'A', '"Poner todas las cartas sobre la mesa"', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 84), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 84), 1),
(UUID(), 'C', '"No descubrir tu propio juego"', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 84), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 85), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 85), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 85), 2),
(UUID(), 'A', 'Es estable y tradicional en sus intereses', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 86), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 86), 1),
(UUID(), 'C', 'Reconsidera seriamente sus puntos de vista sobre la vida', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 86), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF =  87), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 87), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 87), 0),
(UUID(), 'A', 'Me aburre y me da sueño', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 88), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 88), 1),
(UUID(), 'C', 'Me da seguridad y confianza', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 88), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 89), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 89), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 89), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 90), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 90), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 90), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 91), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 91), 1),
(UUID(), 'C', 'Falso, me cuesta ser paciente', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 91), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 92), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 92), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 92), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 93), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 93), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 93), 2),
(UUID(), 'A', 'Verdadero, no me pongo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 94), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 94), 1),
(UUID(), 'C', 'Falso, me pongo intranquilo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 94), 2),
(UUID(), 'A', 'A veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 95), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 95), 1),
(UUID(), 'C', 'Nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 95), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 96), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 96), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 96), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 97), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 97), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 97), 0),
(UUID(), 'A', 'Investigarlo en el laboratorio', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 98), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 98), 1),
(UUID(), 'C', 'Mostrar a las personas su utilización', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 98), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 99), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 99), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 99), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 100), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 100), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 100), 2),
(UUID(), 'A', 'A veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 101), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 101), 1),
(UUID(), 'C', 'Raras veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 101), 0),
(UUID(), 'A', 'No protestaría y les seguiría', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 102), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 102), 1),
(UUID(), 'C', 'Les haría saber que yo creía que mi camino era mejor', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 102), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 103), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 103), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 103), 2),
(UUID(), 'A', 'Lo indicaría y lo pagaría', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 104), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 104), 1),
(UUID(), 'C', 'Yo no tengo por qué decírselo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 104), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 105), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 105), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 105), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 106), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 106), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 106), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 107), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 107), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 107), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 108), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 108), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 108), 2),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 109), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 109), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 109), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 110), 1),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 110), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 110), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 111), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 111), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 111), 2),
(UUID(), 'A', 'Verdadero, no se puede confiar en ella', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 112), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 112), 1),
(UUID(), 'C', 'Falso, se puede confiar en ella', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 112), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 113), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 113), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 113), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 114), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 114), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 114), 2),
(UUID(), 'A', 'A veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 115), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 115), 1),
(UUID(), 'C', 'Nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 115), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 116), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 116), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 116), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 117), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 117), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 117), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 118), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 118), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 118), 0),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 119), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 119), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 119), 2),
(UUID(), 'A', 'Los artículos sobre los problemas sociales', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 120), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 120), 1),
(UUID(), 'C', 'Todas las noticias locales', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 120), 2),
(UUID(), 'A', 'Leer o trabajar en solitario en un proyecto', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 121), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 121), 1),
(UUID(), 'C', 'Hacer alguna tarea con los amigos', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 121), 2),
(UUID(), 'A', 'Dejarlo a un lado hasta que no haya más remedio que hacerlo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 122), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 122), 1),
(UUID(), 'C', 'Comenzar a hacerlo de inmediato', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 122), 0),
(UUID(), 'A', 'Con un grupo de gente', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 123), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 123), 1),
(UUID(), 'C', 'En solitario', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 123), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 124), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 124), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 124), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 125), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 125), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 125), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 126), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 126), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 126), 2),
(UUID(), 'A', 'Cálida y amigable', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 127), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 127), 1),
(UUID(), 'C', 'Formal y objetiva', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 127), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 128), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 128), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 128), 2),
(UUID(), 'A', 'Hacer o reparar algo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 129), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 129), 1),
(UUID(), 'C', 'Trabajar en grupo en una tarea comunitaria', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 129), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 130), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 130), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 130), 2),
(UUID(), 'A', 'Normalmente verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 131), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 131), 1),
(UUID(), 'C', 'Normalmente falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 131), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 132), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 132), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 132), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 133), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 133), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 133), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 134), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 134), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 134), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 135), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 135), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 135), 2),
(UUID(), 'A', 'Podría incumplirlas si tiene razones especiales para ello', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 136), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 136), 1),
(UUID(), 'C', 'Debería seguirlas a pesar de todo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 136), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 137), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 137), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 137), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 138), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 138), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 138), 0),
(UUID(), 'A', 'Casi nunca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 139), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 139), 1),
(UUID(), 'C', 'A menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 139), 2),
(UUID(), 'A', 'Hacer o construir algo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 140), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 140), 1),
(UUID(), 'C', 'Leer o imaginar cosas ideales', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 140), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 141), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 141), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 141), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 142), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 142), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 142), 2),
(UUID(), 'A', 'Normalmente verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 143), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 143), 1),
(UUID(), 'C', 'Normalmente falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 143), 0),
(UUID(), 'A', 'A veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 144), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 144), 1),
(UUID(), 'C', 'Raras veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 144), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 145), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 145), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 145), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 146), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 146), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 146), 2),
(UUID(), 'A', 'Se cuestionan o cambian métodos que son ya satisfactorios', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 147), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 147), 1),
(UUID(), 'C', 'Descartan enfoques nuevos o prometedores', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 147), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 148), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 148), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 148), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 149), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 149), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 149), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 150), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 150), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 150), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 151), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 151), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 151), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 152), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 152), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 152), 2),
(UUID(), 'A', 'Siempre', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 153), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 153), 1),
(UUID(), 'C', 'A veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 153), 2),
(UUID(), 'A', 'Algunos trabajos no deberían ser hechos tan cuidadosamente como otros', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 154), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 154), 1),
(UUID(), 'C', 'Cualquier trabajo habría que hacerlo bien si es que se va a hacer', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 154), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 155), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 155), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 155), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 156), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 156), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 156), 2),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 157), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 157), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 157), 0),
(UUID(), 'A', 'Sí', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 158), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 158), 1),
(UUID(), 'C', 'No', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 158), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 159), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 159), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 159), 2),
(UUID(), 'A', 'Muy raras veces', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 160), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 160), 1),
(UUID(), 'C', 'Bastante a menudo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 160), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 161), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 161), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 161), 2),
(UUID(), 'A', 'Verdadero, puedo afrontarlos fácilmente', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 162), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 162), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 162), 2),
(UUID(), 'A', 'No le doy importancia', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 163), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 163), 1),
(UUID(), 'C', 'Se lo digo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 163), 2),
(UUID(), 'A', 'Ser claramente serio en la vida cotidiana', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 164), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 164), 1),
(UUID(), 'C', 'Seguir casi siempre el dicho "Diviértete y sé feliz"', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 164), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 165), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 165), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 165), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 166), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 166), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 166), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 167), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 167), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 167), 2),
(UUID(), 'A', 'Se sigan normas estrictas de conducta', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 168), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 168), 1),
(UUID(), 'C', 'No haya muchas normas', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 168), 0),
(UUID(), 'A', 'Verdadero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 169), 0),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 169), 1),
(UUID(), 'C', 'Falso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 169), 2),
(UUID(), 'A', 'Un programa sobre nuevos inventos prácticos', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 170), 2),
(UUID(), 'B', '?', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 170), 1),
(UUID(), 'C', 'Un concierto de un artista famoso', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 170), 0),
(UUID(), 'A', 'Minuto', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 171), 1),
(UUID(), 'B', 'Milisegundo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 171), 0),
(UUID(), 'C', 'Hora', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 171), 0),
(UUID(), 'A', 'Araña', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 172), 0),
(UUID(), 'B', 'Gusano', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 172), 0),
(UUID(), 'C', 'Insecto', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 172), 1),
(UUID(), 'A', 'Cordero', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 173), 0),
(UUID(), 'B', 'Pollo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 173), 1),
(UUID(), 'C', 'Merluza', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 173), 0),
(UUID(), 'A', 'Lava', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 174), 0),
(UUID(), 'B', 'Arena', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 174), 0),
(UUID(), 'C', 'Petróleo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 174), 1),
(UUID(), 'A', 'Malo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 175), 0),
(UUID(), 'B', 'Santo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 175), 0),
(UUID(), 'C', 'Óptimo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 175), 1),
(UUID(), 'A', 'Terminal', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 176), 0),
(UUID(), 'B', 'Estacional', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 176), 1),
(UUID(), 'C', 'Cíclico', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 176), 0),
(UUID(), 'A', 'Gato', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 177), 0),
(UUID(), 'B', 'Cerca', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 177), 1),
(UUID(), 'C', 'Planeta', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 177), 0),
(UUID(), 'A', 'Bueno', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 178), 1),
(UUID(), 'B', 'Erróneo', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 178), 0),
(UUID(), 'C', 'Adecuado', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 178), 0),
(UUID(), 'A', 'Probable', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 179), 0),
(UUID(), 'B', 'Eventual', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 179), 1),
(UUID(), 'C', 'Inseguro', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 179), 0),
(UUID(), 'A', 'Casual', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 180), 0),
(UUID(), 'B', 'Puntual', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 180), 1),
(UUID(), 'C', 'Incorrecto', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 180), 0),
(UUID(), 'A', '20', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 181), 0),
(UUID(), 'B', '25', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 181), 1),
(UUID(), 'C', '32', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 181), 0),
(UUID(), 'A', 'H', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 182), 1),
(UUID(), 'B', 'K', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 182), 0),
(UUID(), 'C', 'J', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 182), 0),
(UUID(), 'A', 'M', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 183), 0),
(UUID(), 'B', 'N', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 183), 0),
(UUID(), 'C', 'O', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 183), 1),
(UUID(), 'A', '3 / 4', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 184), 1),
(UUID(), 'B', '4 / 3', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 184), 0),
(UUID(), 'C', '3 / 2', (SELECT idPregunta16PF FROM preguntas16PF WHERE numeroPregunta16PF = 184), 0),
...
----------------------------------------------------------------------------------------------------------------------NUEVA-------------------------------------------------------
INSERT INTO interpretaciones16PF(parametro, nivel1, nivel2, nivel3)  VALUES 
('A', 'Muestra tendencia a ser una persona de tipo reservada y formal en su interacción social. Puede mostrar más preferencia por trabajar aislado de los demás que en un equipo de trabajo. En ocasiones puede ser crítica e inflexible.',
'Presenta nivel medio de sociabilidad. Aunque no manifiesta demasiado interés por la interacción social, puede desempeñarse en ella sin mayores dificultades.',
'Personalidad de tipo afectuosa, cálida y amable en sus relaciones interpersonales. Suele mostrar interés por el trabajo en equipo. Puede disfrutar empleos en los que se enfatiza la interacción social. Suele manifestar interés por los proyectos grupales.'),
('B', 'Nivel de inteligencia bajo. Suele ser una persona de tipo lenta para aprender y asimilar situaciones. Se muestra inclinada a interpretaciones de tipo literales y concretas. Pensamiento concreto.',
'Presenta nivel de pensamiento medio. Aunque su puntaje no es alto, puede encontrarse en capacidad de analizar y resolver problemas en situaciones normales.',
'Muestra tendencia a ser una persona de rápida comprensión y asimilación de conceptos. Nivel de inteligencia superior y pensamiento de tipo abstracto.'),
('C', 'Presenta dificultades en cuanto a la inestabilidad emocional. Tiende a presentar baja tolerancia a la frustración. Puede presentar dificultades en cuanto a la adaptación a situaciones nuevas. A menudo presenta carácter de tipo voluble.',
'Es una persona medianamente adaptada a su realidad psicosocial. Algunas situaciones estresantes podrían generarle dificultades de tipo emocional. Sin embargo, su mediano nivel de fortaleza de ego puede a veces ayudarle a sobrellevar la situación.',
'Persona que suele adaptarse adecuadamente al ambiente que la rodea. Suele ser realista y estable a nivel emocional. No presenta dificultades  en cuanto al afrontamiento de la realidad. Suele ser conocida como una persona madura y realista por las demás personas.'),
('E', 'Muestra tendencia a ser una persona humilde, sumisa y dócil frente a los demás. Suele ser conformista y pasiva. A veces puede preferir dejarse llevar por lo que opine la mayoría. Puede mostrarse complasiva para evitar conflictos con las demás personas.',
'Presenta un mediano grado de control sobre los demás. No es una persona de tipo dominante en sus relaciones sociales. No muestra mucho interés por ocupar posiciones de mando sobre las demás personas.',
'Suele ser una persona de tipo dominante en sus relaciones interpersonales. Puede mostrar interés por la competencia. Prefiere situaciones de mando y poder sobre otros. Presenta tendencia a la asertividad. Suele ser una persona segura de sí misma.'),
('F', 'Presenta características relacionadas con la introspección y la seriedad a nivel de comportamiento. Es una persona sobria y prudente.',
'A menudo no es descrita como una persona muy animada y activa en situaciones de grupo.',
'Tiende a ser una persona de tipo entusiasta, espontánea, expresiva y alegre en su interacción con el entorno. A menudo es considerada como una persona activa y dinámica. Puede presentar características relacionadas con el liderazgo.'),
('G', 'Persona que difícilmente se comporta de acuerdo con las normas y reglas de una sociedad. Maneja una escala de valores distinta a la de la sociedad en que vive.',
'Persona con valores morales y normatividad medianamente adaptada a su forma de ver la vida. No es conocida como una persona normativa.',
'Persona muy normativa. Tiende a actuar siempre de acuerdo con las normas. Suele ser una persona muy responsable. Por lo general es conocida como de carácter exigente y organizada en sus actividades.'),
('H', 'Presenta dificultad a nivel de habilidades sociales. Muestra tendencia a la timidez y al retraimiento. Puede mostrar dificultades para trabajar bajo presión. Prefiere limitarse a lo seguro y conocido para evitar posibles riesgos o complicaciones.',
'Presenta nivel mediano de sociabilidad. No suele ser conocida como una persona muy expresiva.',
'Persona que puede funcionar bajo altos niveles de estrés. A menudo le gusta correr riesgos. Puede tener tendencia a la asertividad. Normalmente son conocidas como personas emprendedoras.'),
('I', 'Persona con pensamiento de tipo racional. Suele ser conocida como práctica y realista. En ocasiones puede ser independiente y escéptica. Tendencia a ser constante en sus tareas.',
'No es conocida por los demás como una persona de tipo sentimental y emotiva, ni tampoco como muy racional y práctica. Se encuentra en el medio de ambos polos.',
'Persona que funciona bajo el domino de sus sentimientos. Muestra tendencia a ser emotiva y de sensibilidad extrema. Suele ser descrita como una persona de tipo tierna y sensible. Personalidad de tipo idealista.'),
('L', 'Persona confiada, amable y receptiva con el resto de la sociedad. Es muy dada a las labores sociales y humanitarias. A menudo se muestra comprensiva y abierta a las demás personas. Persona apta para el trabajo en equipo y las relaciones sociales.',
'Presenta identidad social medianamente adecuada. No suele ser conocida ni como una persona confiada ni desconfiada de las demás personas.',
'Muestra tendencia a ser una persona de tipo desconfiada y suspicaz con las demás personas. Puede presentar características de personalidad relacionadas con los celos y el escepticismo. Suele presentar dificultades en sus relaciones interpersonales.'),
('M', 'A menudo es reconocida como una persona objetiva y poco emocional. Tendencia a ser de tipo práctica y centrada.',
'A menudo no es conocida como una persona de tipo idealista ni tampoco como una persona realista y objetiva. Se encuentra en el medio de ambos polos.',
'Normalmente suele ser reconocida como una persona de tipo creativa y de gran imaginación. A menudo es una persona proactiva y poco convencional.'),
('N', 'Suele ser conocida como una persona abierta y sincera en sus relaciones sociales. Tendencia a la espontaneidad y a la autenticidad en el trato hacia las demás personas.',
'No suele ser descrita como una persona abierta a los demás, ni tampoco como de tipo territorial y distante. Se encuentra en el medio de ambos polos.',
'Suele ser una persona con alta territorialidad. Tendencia a ser analítica y calculadora en sus relaciones sociales. Es una persona fría, diplomática y táctica.'),
('O', 'Presenta una autoestima bien desarrollada que la hace sentir segura y cómoda en sus relaciones interpersonales. No presenta autocrítica ni autoexigencia de tipo desadaptativa.',
'Presenta nivel de autoestima medianamente adecuado, lo que le permite interactuar a nivel social, aunque a veces puede presentar dificultades referentes a ésta situación.',
'Persona de tipo ansiosa y aprensiva. A menudo experimenta sentimientos de culpa originados por niveles de crítica de sí misma. Puede presentar dificultades a nivel de autoestima. Tendencia a la autoexigencia de tipo desadaptativa.'),
('Q1', 'Persona con resistencia al cambio y preferencia por lo conocido y tradicional. Prefiere seguir normas tradicionales incluso aunque se encuentren en desuso.',
'No califica como persona con resistencia al cambio aunque tampoco se puede describir como abierta y dispuesta al cambio. Se encuentra en el medio de ambos polos.',
'Persona abierta y dispuesta al cambio. Tiende a ser muy liberal y a rechazar lo tradicional y convencional. Maneja un tipo de pensamiento libre y abierto a todas las posibilidades que se puedan presentar.'),
('Q2', 'Persona de tipo dependiente del grupo. Puede carecer de autonomía decisional. A menudo consulta antes de tomar decisiones y en general puede necesitar el apoyo del grupo.',
'No es conocida como una persona de tipo autosuficiente, ni tampoco como dependiente de los demás. Se encuentra en el medio de ambos polos.',
'Persona de tipo autosuficiente que suele hacer sus tareas sin pedir ayuda de los demás. Puede disfrutar más de la soledad que de la compañía de otros. A menudo es conocida como persona con criterio propio y recursos internos para sortear dificultades.'),
('Q3', 'Persona que suele privilegiar sus intereses por encima de los del grupo. Puede presentar dificultades para trabajar en equipo. No es una persona de tipo perfeccionista.',
'Presenta adaptación de tipo social en un nivel medio. Tiende a responder del mismo modo a los deseos internos como a los de las demás personas.',
'Persona con características de personalidad de tipo perfeccionista. Puede esforzarse por igualar su conducta a la imagen ideal. Tiende a controlar sus emociones y a mostrar una imagen impecable frente a los demás. Es cuidadosa en lo social.'),
('Q4', 'Su comportamiento suele presentar ausencia de tensión nerviosa. A menudo es conocida como una persona de tipo relajada, tranquila y paciente. Puede mostrarse dispuesta a la colaboración en tareas.',
'Es una persona con nivel mediano de tensiones de tipo emocionales.',
'Persona con características de personalidad de tipo irritable y acelerada. Puede sufrir de altos niveles de estrés y ansiedad que le dificultan el normal desarrollo de sus relaciones interpersonales.'),
('EX', 'Persona con características de personalidad relacionadas con la introversión. Puede presentar tendencia a la timidez y a la inhibición de su conducta social.',
'No es considerada como una persona extrovertida ni tampoco como introvertida. Se encuentra en el medio de ambos polos.',
'Persona con características de personalidad relacionadas con la extroversión. Puede presentar capacidad para crear y mantener contactos interpersonales. Suele ser desinhibida socialmente.'),
('AX', 'Persona de tipo serena, realista y estable emocionalmente. Generalmente es una persona segura de sí misma. No presenta problemas de ansiedad.',
'Persona con mediano nivel de ansiedad. Sin embargo no le genera mayores dificultades para la interacción social.',
'Persona con dificultades a nivel de ansiedad. Tendencia a la inseguridad, tensión e inestabilidad de tipo emocional.'),
('TM', 'Persona de tipo receptiva y abierta a los demás. Su nivel de sensibilidad emocional la hace aparecer ante los demás como una persona afectiva.',
'Persona con nivel mediano de sus emociones. Puede interactuar sin mayores problemas a nivel social.',
'Persona con tendencia a ser de tipo fría e inflexible en sus relaciones interpersonales. Prefiere manejar las distancias a nivel interpersonal, mostrándose reservada y a menudo desconfiada.'),
('IN', 'Persona de tipo dependiente de los demás. Suele someterse a las exigencias y expectativas de otros por encima de las propias. Muestra tendencia a la humildad y la docilidad de comportamiento.',
'No califica como persona de tipo independiente, ni tampoco como dependiente de los demás. Se encuentra en el medio de ambos factores.',
'Persona con características de personalidad de tipo independiente de los demás. A menudo no demuestra interés o necesidad por ser aceptada socialmente. Suele ser autosuficiente y radical.'),
('SC', 'Persona con bajo nivel de control de sus emociones e impulsos internos. Puede presentar dificultades a nivel interpersonal. Suele centrarse más en sus propios impulsos y necesidades.',
'Presenta nivel mediano de control de sus emociones. Sin embargo esta situación no le genera mayores dificultades a nivel interpersonal',
'Persona con adecuado nivel de control de sí misma. Puede mostrar facilidad para adaptarse a normas. Suele ser una persona muy controlada socialmente a nivel de sus emociones.');
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
