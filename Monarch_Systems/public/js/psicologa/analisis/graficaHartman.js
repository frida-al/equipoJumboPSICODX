    ...
    const chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Mundo Interno',
          data: [
            mundoInterno.DimI, mundoInterno.DimE, mundoInterno.DimS,
            mundoInterno.DiF, mundoInterno.DimGeneral, mundoInterno.DimPorcentaje,
            mundoInterno.IntI, mundoInterno.IntE, mundoInterno.IntS,
            mundoInterno.IntGeneral, mundoInterno.IntPorcentaje,
            mundoInterno.Di, mundoInterno.Dis,
            mundoInterno.Sq1, mundoInterno.Sq2,
          ...
          label: 'Mundo Externo',
          data: [
            mundoExterno.DimI, mundoExterno.DimE, mundoExterno.DimS,
            mundoExterno.DiF, mundoExterno.DimGeneral, mundoExterno.DimPorcentaje,
            mundoExterno.IntI, mundoExterno.IntE, mundoExterno.IntS,
            mundoExterno.IntGeneral, mundoExterno.IntPorcentaje,
            mundoExterno.Di, mundoExterno.Dis,
            mundoExterno.Vq1, mundoExterno.Vq2,
            null, null, null, null, null, null
          ],
          borderColor: 'blue',
          ...
          data: [
            ...
            null, null, null, null,
            equilibrio.Bqr1, equilibrio.Bqr2,
            equilibrio.Bqa1, equilibrio.Bqa2,
            equilibrio.Cq1, equilibrio.Cq2
          ],
          borderColor: 'black',
